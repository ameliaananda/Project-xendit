    ...
    <div class="min-h-screen bg-gray-100 py-10">
        ...
        <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-8">
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-6">
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/7/72/Logo_dana_blue.svg" class="h-7" />
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/eb/Logo_ovo_purple.svg" class="h-7" />
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/8/86/Gopay_logo.svg" class="h-7" />
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/5/55/BNI_logo.svg" class="h-7" />
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition mb-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/2/2e/BRI_2020.svg" class="h-7" />
            ...
            <form action="{{ route('payment.process') }}" method="POST">
                ...
                <button type="submit" class="w-full border rounded-lg p-4 hover:shadow-md transition">
